...
C JREC is the 1-based output record number
	...
	SAVE JB5,ND1,ND3,ND4,JREC,MM2,MM3,MM4,MTOT ! insure these remain defined
C
 ...
 110	  FORMAT (/'0TDISK:  Opened ',A,' direct access file = ',A
	...
	ELSE			! setup for BIN5 file
	  ...
	  ELSEIF (K4OUT.EQ.52) THEN 
	    ...
	    MTOT=MD21*MD22*MD23*MD24*MD25 ! worst case size
...
C close the file					4  4  4  4  4  4  4  4
 400	IF (LOPN2) then
	...
	CALL R2R(0.,BMD1,-MTOT) ! ensure possible next set initialized to zero
	GOTO 9
C       
