...
C changing print statement to include more significant figures in temperature output - 09.24.04; r.fergason.
C 903   format (' 11',F6.1,F6.1,F6.2,F5.1,F5.2,F7.1,F5.2,F5.1,F5.0,2f7.1)
