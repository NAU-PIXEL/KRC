...
100	NFD=NFDR ! transefer sizes into comon
	...
	ELSE		!  READ parameter cards
	  ...
	  READ (IOIN,'(/8F10.2)'  ,END=330) (FD(I),I=1,NFD)
	  READ (IOIN,'(/8I10)'    ,END=330) (ID(I),I=1,NID)
	  READ (IOIN,'(/10L7)'    ,END=330) (LD(I),I=1,NLD)
	  READ (IOIN,'(/(10F7.2))',END=330) (ALAT(I),I=1,N4)
	  READ (IOIN,'(/(10F7.2))',END=330) (ELEV(I),I=1,N4)
	ENDIF
