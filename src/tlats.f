...
C 2014apr27 HK untabify  Remove unused variables from trig slope solution
C_End6789012345678901234567890123456789012345678901234567890123456789012_4567890
C
      REAL*4 DERI(2,2)            ! diffuse irradiances from Delta-Eddington
      REAL*4 COSIAM(2)            ! cos_incidence angle: average and noon
...
C Get diffuse insolation, including twilight and first-order surface reflection 
         IF (COSI.GT.TWILIM) THEN ! in day or twilight zone
           ...
           IF (LATM.AND.(COS3.GT.1.E-5)) THEN ! direct onto slope
...
C       
         ...
         AVEI=AVEI+QI
         AVEH=AVEH+QA
         IF (LQ3) WRITE(79,777) JJ,COSI,COLL,QA,QI,DIRECT,DIFFUSE,BOUNCE
