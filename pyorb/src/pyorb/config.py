...
test_kernels_dir = src_dir.parent / "test/kernels"
...
def load_config() -> tuple[Path, Path]:
    ...
    Raises:
        ...
        ValueError: Returned when the config file has no value set for porb_defaults_dir
        ValueError: Returned when the config file has no value set for kernels_dir
