...
Base conditions for One-Point Mode
    ALBEDO     EMISS   INERTIA        BK       BRC    PERIOD  SPECHEAT   DENSITY
       .25      1.00     200.0      2.00      1.00    1.0275       15.      1.60
      CABR    ABRAMP    ABRPHA    PTOTAL     FANON      TATM     TDEEP     spare
      0.02      .025      190.    150.26      .055      200.      200.       0.0
      TAUD     DUSTA    TAURAT     TWILI      ACR2      ARC3     SLOPE    SLOAZI
       0.4       .22        .5       5.0       0.9       1.0       0.0       90.
    TFROST    CFROST    AFROST     FEMIS       AF1       AF2    FROEXT     spare
     148.0      141.       .65      1.00      0.65     0.001       5.0       5.6
      RLAY      FLAY     CONVF     DEPTH     DRSET       DDT       GGT     FDOWN
    1.2000     .1800    2.0000       0.0       0.0     .0020     .1000       1.0
      DJUL    DELJUL  SOLARDEC       DAU      HLON    SOLCON      GRAV     spare
    8948.4   17.1745      00.0     1.465        .0     1368.     3.727     12.34
        N1        N2        N3        N4        N5       N24        IB        IC
        13       384        10         1         1        24         0         0
    ...
    LP1    LP2    LP3    LP4    LP5    LP6 LPGLOB   LVFA   LVFT  debug
      F      F      F      F      F      F      F      F      F      F
  LPORB   LKEY    LSC LNOTIF  LOCAL  spare LPTAVE  spare  debug  debug
      T      F      F      F      F      F      F      F      F      F
...
10 1 0.1 'onepoint.inp' / name of one-point input file
0 /
0 /
0 / 
