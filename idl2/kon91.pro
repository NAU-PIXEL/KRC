...
; -3 -1 -9 100,1,2 121 122 8 80 800,1,2,3,4,8 80 81 850:860 880:899  
...
81: begin                       ; start color plot file
set_plot,'PS'                   ; use the Postscript device
device,file='cidl.eps',/color,bits=8,/landscape ;, /encapsulated 
end

82: if !d.name eq 'PS' then begin  ;+ end 
DEVICE,/close_file 
print,'Now: mv cidl.eps'
SET_PLOT,'X'
DEVICE,retain=2
endif
