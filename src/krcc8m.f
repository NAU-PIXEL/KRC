...
C      PARAMETER (MAXN5 =2161)    ! dimension of saved seasons
     ...
     &,LWRITEASOL, LWRITESOLDIF, LWRITEPLANV,LWRITEPLANH
      ...
      LOGICAL*1 LASOLTAB, LSOLDIFTAB, LPLANVTAB, LPLANHTAB, LRAWTAB
...
Cset   seas lat day2   lats -------day1------- --main------
     ...
     9,KOLD,KVALB,ID24,NUMVER,KFARAC,NBKRC,NFD,NID,NLD            ! 21:30
Cset             ----card---
...
Cset   ---day1- lat ----day1-    main -day2- lats  seas
     ...
     D,KITLE,DAYTIM,LHEMISEMIS, LFLUX  !
     E,LASOLTAB, LSOLDIFTAB, LPLANVTAB, LPLANHTAB, LRAWTAB
