...
\qbn \frac{\partial T}{\partial t} = \frac{-1}{\rho C} \frac{\partial}{\partial
  z} \left( -k \frac{\partial}{\partial z} \right) \ \ = \ \ \frac{k}{\rho C} \frac{\partial
  ^2T}{\partial z^2} \hcm1 \mathrm{or} \hcm1  \frac{\Delta T_i}{\Delta t} = -\frac{ H_{i+1/2} -H_{i-1/2}}{B_i \rho_i C_i} \qen
...
$\epsilon$   & \ct{EMIS} &   & S,R$_f$ & Surface emissivity.  FEMIS for frost \\
$\theta$   & \ct{DLAT} &   & S & Latitude. $\theta_2$ = latitude + slope north
\\
$\mu_0$ &  \ct{COSI} &  & R & Cosine of the incidence angle \\
$\varpi$ & \ct{OMEGA} & DUSTA & 0.9 \ C & Dust grain single scattering
albedo. MARS p.1030 \\
$\Omega$ & \ct{SKYFAC} & $\equiv 1-\alpha$ & SR & Fraction of the sky (upper hemisphere) that is visible to the surface \\ 
