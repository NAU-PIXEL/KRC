...
Run I: all with RLAY=1.1, FLAY=0.05and N2=6144.; set of decreasing number of layers from 30 to 22. Three sets, with CONVG 2,4 and 8; if adequately deep (D=5.), MAR is .140, .042, and  0.029 respectively. Increase in error less than factor of 2 if NLAY=24 or more; D=3.98 .  
