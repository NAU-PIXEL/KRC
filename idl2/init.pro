...
; 2012jan24 HK increase TVFAST_COM to dimension (6)
;_End

common TVFAST_COM, safe ; intarr(6) [X,Y Display pixel limits, backing]
; see setwind.pro
...
win=[1280,1000]                 ; Common maximum display size
mybw='HP_Laserjet_3330'         ; B&W printer
myclr=mybw                      ; Color printer.only B&W for hulk
case cpu of
...
safe=[win,retain, 640,512,retain] ; Init display size and backing store in Common
SETCOLOR,850                        ; Start the colors. Will define !binc
