# Makefile for exported KRC   2004jul21
##########################################################################
# krc_system.rules
#
...
LD=gcc
LDOPTS=
LDSHAREDOPTS=-shared -Wl,--whole-archive	#?? not -Wl,
SHARELIBS=
LDFLAGS=$(LDOPTS)
...
#? not used?  NRLIB = -L/usr/local/lib -lsys_nrf
...
OBJUTIL = catime.o datime.o idarch.o sigma.o vaddsp.o xtreme.o binf5.o white1.o
