...
yb= 3.34 + 0.12316*Tin          ; <j/(mole*deg)> fit fig 5.7, 75:250K
...
; plot,ty,yy,psym=4
    case arg3 of
        1: begin  & out=yb & ref=ref+' Hobbs'     ; Hobbs Cp
            arg4= 0.4685 + 488.19/Tin ; <J m^-1 s^-1 K^-1> Hobbs p.360  2.256
