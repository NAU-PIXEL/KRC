...
; 854,6,8,9 =4:15 colors 857=all black for printer.  855=use kink in common
;_Vars
...
; start repeating, or make the lines wider.
  case inj of
    ...
    857: kink=replicate(cblack,6) ; all black, insurance for printer
    858: kink=[13,111,151,190,235,247,255,61] ; 6+white+darkBlue
    859: kink=[13,61,111,151,190,216,235,255,247,2,20,130,40,1] ; 7+white+7
    else: Message,' invalid 85x call  x: 1=B+W 2=W+B 3=pre 4,5=kink,6,8,9= # colors',/cont
  endcase
...
print,'  854,6,8 = 4,6,8,15  colors  855= use kink        857: all black'
