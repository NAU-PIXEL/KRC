...
;             [4] is dodp : flag for R*8 data file
...
khold=[long(lun),mmm,ncase,front[0],dodp]  ; ensure long array; mmm could be big some time
...
dodp=khold[4] ; flag for R*8 words
if dodp then begin
...
out=DEFINEKRC('KRC',nbyt=i)           ; define the structure
