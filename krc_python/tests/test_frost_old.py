...
class TestGetFrostParamsForBody:
    ...
    def test_mars_co2_frost(self):
        ...
        assert CFROST == pytest.approx(3182.48, rel=0.01)
        assert AFROST == pytest.approx(23.3494, rel=0.01)

    def test_mars_pressure_dependence(self):
        """Test that Mars frost temperature varies with pressure."""
        ...
        # Higher pressure -> higher frost temperature
