...
*                                       C strings
*_Parm  int  ostrlen;              I   Length of each reformatted
*                                       FORTRAN type string
*_Parm  int  keep_pad;             I   Specifies FORTRAN padding.
